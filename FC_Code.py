#Fully connected network for classyfing images of landscapes into 6 categories
import scipy as sp
import numpy as np
...
trainpath = "D:\IACS Sem 7\Advanced Machine Learning\ImageClassification\Train"
valpath = "D:\IACS Sem 7\Advanced Machine Learning\ImageClassification\Validation"
testpath = "D:\IACS Sem 7\Advanced Machine Learning\ImageClassification\Test"
predpath = "D:\IACS Sem 7\Advanced Machine Learning\ImageClassification\Prediction"
...
#{'buildings': 0, 'forest': 1, 'glacier': 2, 'mountain': 3, 'sea': 4, 'street': 5} (Categories in Test Data)

#Model Architecture:
#2 hidden layers with 100 neurons each
#output layer with 6 neurons for classification
#150x150 pixels
...
#Modified network with l2 regularisation on weights
...
#The gap between training and validation accuracy is significantly reduced.
#l2 regularisation and dropout reduces overfitting. The model generalises better. 

#Stop training if validation loss increases for 5 consecutive epochs. This is intended to improve generalisation.
...
#Accuracy on validation set improves significantly with early stopping
